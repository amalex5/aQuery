...
pprint (Mul t@(Add _ _) z) = pprint z ++ "*(" ++ pprint t ++ ")"
pprint (Mul z t@(Add _ _)) = pprint z ++ "*(" ++ pprint t ++ ")"
pprint (Mul t@(Sub _ _) z) = pprint z ++ "*(" ++ pprint t ++ ")"
pprint (Mul t@(Div _ _) z) = pprint z ++ "/(" ++ pprint t ++ ")"
